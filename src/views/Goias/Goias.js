...
import {
  LineChartsGO,
  LineChartsGODia,
  LineChartsGOConfRate,
  LineChartsGOLetal,
 // CardsGO,
  HBarChartsDistrictsInfGO,
  HBarChartsDistrictsDeathGO
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosGOConfirmed,DadosGODeceased} from '../../components/API/GO';
...
class Goias extends Component {
  state = {
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosGOConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosGOConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosGODeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosGODeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosGOConfirmed ,DadosGODeceased,dateUpdate} = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosGODeceased/DadosGOConfirmed)*100).toFixed(2)
   const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosGOConfirmed ).toFixed(0)
   const calcPercentPopulationInfected = () => ((calcEstimateInfected()/7018354)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosGOFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/GO.gif')} alt="GO" height='34' width='56'></img>
                </div>
                <div className="text-value">
                Goias
                  </div>
                  
                <div>População estimada(2019):&nbsp;7.018.354</div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosGOConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosGODeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsGODia></LineChartsGODia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsGOConfRate></LineChartsGOConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsGOLetal></LineChartsGOLetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfGO></HBarChartsDistrictsInfGO>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathGO></HBarChartsDistrictsDeathGO>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartGOInf></PieChartGOInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartGODeat></PieChartGODeat>
            </Card>
          </Col>
          </Row>
