...
import {
  LineChartsRN,
  LineChartsRNDia,
  LineChartsRNConfRate,
  LineChartsRNLetal,
  //CardsRN,
  HBarChartsDistrictsInfRN,
  HBarChartsDistrictsDeathRN
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosRNConfirmed,DadosRNDeceased} from '../../components/API/RN';
...
import styles from './RioGrandeDoNorte.css';
...
class RioGrandeDoNorte extends Component {
  state = {
    DadosRNConfirmed: {},
    DadosRNDeceased :{},
    dateUpdate: {},
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosRNConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosRNConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosRNDeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosRNDeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosRNConfirmed ,DadosRNDeceased,dateUpdate} = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosRNDeceased/DadosRNConfirmed)*100).toFixed(2)
  //const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosRNConfirmed ).toFixed(0)
   //const calcPercentPopulationInfected = () => ((calcEstimateInfected()/3506853)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosRNFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/RN.gif')} alt="RN" height='34' width='56'></img>
                </div>
                <div className="text-value">
                Rio Grande Do Norte
                  </div>
                  
                <div>População estimada(2019):&nbsp;3.506.853 </div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosRNConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosRNDeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsRNDia></LineChartsRNDia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsRNConfRate></LineChartsRNConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsRNLetal></LineChartsRNLetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfRN></HBarChartsDistrictsInfRN>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathRN></HBarChartsDistrictsDeathRN>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartRNInf></PieChartRNInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartRNDeat></PieChartRNDeat>
            </Card>
          </Col>
          </Row>
