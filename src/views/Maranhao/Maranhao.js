...
import {
  LineChartsMA,
  LineChartsMADia,
  LineChartsMAConfRate,
  LineChartsMALetal,
  //CardsMA,
  HBarChartsDistrictsInfMA,
  HBarChartsDistrictsDeathMA
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosMAConfirmed,DadosMADeceased} from '../../components/API/MA';
...
import styles from './Maranhao.css';
...
class Maranhao extends Component {
  state = {
    DadosMAConfirmed: {},
    DadosMADeceased :{},
    dateUpdate: {},
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosMAConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosMAConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosMADeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosMADeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosMAConfirmed ,DadosMADeceased,dateUpdate} = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosMADeceased/DadosMAConfirmed)*100).toFixed(2)
   //const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosMAConfirmed ).toFixed(0)
   //const calcPercentPopulationInfected = () => ((calcEstimateInfected()/7075181	)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosMAFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/MA.gif')} alt="MA" height='34' width='56'></img>
                </div>
                <div className="text-value">
                Maranhão
                  </div>
                <div>População estimada(2019):&nbsp;7.075.181	 </div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosMAConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosMADeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsMADia></LineChartsMADia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsMAConfRate></LineChartsMAConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsMALetal></LineChartsMALetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfMA></HBarChartsDistrictsInfMA>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathMA></HBarChartsDistrictsDeathMA>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartMAInf></PieChartMAInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartMADeat></PieChartMADeat>
            </Card>
          </Col>
          </Row>
