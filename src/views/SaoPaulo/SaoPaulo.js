...
import {
  LineChartsSP,
  LineChartsSPDia,
  LineChartsSPConfRate,
  LineChartsSPLetal,
 // CardsSP,
  HBarChartsDistrictsInfSP,
  HBarChartsDistrictsDeathSP
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosSPConfirmed,DadosSPDeceased} from '../../components/API/SP';
...
import styles from './SaoPaulo.css';
...
class SaoPaulo extends Component {
  state = {
    DadosSPConfirmed: {},
    DadosSPDeceased :{},
    dateUpdate: {},
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosSPConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosSPConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosSPDeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosSPDeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosSPConfirmed ,DadosSPDeceased,dateUpdate} = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosSPDeceased/DadosSPConfirmed)*100).toFixed(2)
   //const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosSPConfirmed ).toFixed(0)
   //const calcPercentPopulationInfected = () => ((calcEstimateInfected()/45919049)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosSPFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/SP.gif')} alt="SP" height='34' width='56'></img>
                </div>
                <div className="text-value">
                São Paulo
                  </div>
                  
                <div>População estimada(2019):&nbsp;45.919.049</div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosSPConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosSPDeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsSPDia></LineChartsSPDia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsSPConfRate></LineChartsSPConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsSPLetal></LineChartsSPLetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfSP></HBarChartsDistrictsInfSP>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathSP></HBarChartsDistrictsDeathSP>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartSPInf></PieChartSPInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartSPDeat></PieChartSPDeat>
            </Card>
          </Col>
          </Row>
