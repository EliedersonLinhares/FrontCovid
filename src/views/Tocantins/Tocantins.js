...
import {
  LineChartsTO,
  LineChartsTODia,
  LineChartsTOConfRate,
  LineChartsTOLetal,
 // CardsTO,
  HBarChartsDistrictsInfTO,
  HBarChartsDistrictsDeathTO
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosTOConfirmed,DadosTODeceased} from '../../components/API/TO';
...
import styles from './Tocantins.css';

class Tocantins extends Component {
  state = {
    DadosTOConfirmed: {},
    DadosTODeceased :{},
    dateUpdate: {},
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosTOConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosTOConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosTODeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosTODeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosTOConfirmed ,DadosTODeceased,dateUpdate} = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosTODeceased/DadosTOConfirmed)*100).toFixed(2)
  // const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosTOConfirmed ).toFixed(0)
  // const calcPercentPopulationInfected = () => ((calcEstimateInfected()/1572866)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosTOFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/TO.gif')} alt="TO" height='34' width='56'></img>
                </div>
                <div className="text-value">
                Tocantins 
                  </div>
                  
                <div>População estimada(2019):&nbsp;1.572.866 </div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosTOConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosTODeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsTODia></LineChartsTODia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsTOConfRate></LineChartsTOConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsTOLetal></LineChartsTOLetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfTO></HBarChartsDistrictsInfTO>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathTO></HBarChartsDistrictsDeathTO>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartTOInf></PieChartTOInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartTODeat></PieChartTODeat>
            </Card>
          </Col>
          </Row>
