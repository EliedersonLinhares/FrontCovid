...
import {
  LineChartsAC,
  LineChartsACDia,
  LineChartsACConfRate,
  LineChartsACLetal,
  //CardsAC,
  HBarChartsDistrictsInfAC,
  HBarChartsDistrictsDeathAC
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosACConfirmed,DadosACDeceased} from '../../components/API/AC';
...
class Acre extends Component {
  state = {
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosACConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosACConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosACDeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosACDeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosACConfirmed ,DadosACDeceased,dateUpdate } = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosACDeceased/DadosACConfirmed)*100).toFixed(2)
   //const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosACConfirmed ).toFixed(0)
   //const calcPercentPopulationInfected = () => ((calcEstimateInfected()/881935)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosACFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/AC.gif')} alt="AC" height='34' width='56'></img>
                </div>
                <div className="text-value">
                Acre 
                  </div>
                  
                <div>População estimada(2019):&nbsp;881.935</div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosACConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosACDeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsACDia></LineChartsACDia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsACConfRate></LineChartsACConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsACLetal></LineChartsACLetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfAC></HBarChartsDistrictsInfAC>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathAC></HBarChartsDistrictsDeathAC>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartACInf></PieChartACInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartACDeat></PieChartACDeat>
            </Card>
          </Col>
          </Row>
