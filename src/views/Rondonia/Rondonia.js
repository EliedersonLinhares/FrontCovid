...
import {
  LineChartsRO,
  LineChartsRODia,
  LineChartsROConfRate,
  LineChartsROLetal,
 // CardsRO,
  HBarChartsDistrictsInfRO,
  HBarChartsDistrictsDeathRO
} from '../../components';
//Como o arquivo é o index.js não precisa escreve-lo diretamente
import { DadosROConfirmed,DadosRODeceased} from '../../components/API/RO';
...
import styles from './Rondonia.css';
...
class Rondonia extends Component {
  state = {
    DadosROConfirmed: {},
    DadosRODeceased :{},
    dateUpdate: {},
   ...
   async componentDidMount() {
    ...
    const fetchedInfected = await DadosROConfirmed();
    //console.log(fetchedInfected);
    this.setState({DadosROConfirmed: fetchedInfected});

    const fetchedDeceased = await DadosRODeceased ();
    //console.log(fetchedInfected);
    this.setState({DadosRODeceased : fetchedDeceased});
...
//infected: 101147, deceased: 7025, lastUpdatedAtSource:
  ...
  render() {
    const { DadosROConfirmed ,DadosRODeceased,dateUpdate} = this.state
   // console.log(data)

   const calcDeathRate = () => ((DadosRODeceased/DadosROConfirmed)*100).toFixed(2)
  // const calcEstimateInfected = () => ((calcDeathRate() - 2 ) * DadosROConfirmed ).toFixed(0)
   //const calcPercentPopulationInfected = () => ((calcEstimateInfected()/1777225	)*100).toFixed(2)
   //const calcDoubleTimeDeaths = () => DadosROFull.filter(el => el.new_deaths[1])
    ...
    return (
      <div className="animated fadeIn" style={{ backgroundColor: '#13131A'}}>
        ...
        <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                  <img src={require('../../assets/img/brand/RO.gif')} alt="RO" height='34' width='56'></img>
                </div>
                <div className="text-value">
                Rondônia
                  </div>
                  
                <div>População estimada(2019):&nbsp;1.777.225		 </div>
                <br></br>
                <br></br>
              </CardBody>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosROConfirmed} duration= {2.5} />
                  </div>
          ...
          <Col xs="12" sm="4" lg="4">
            <Card className="text-white " style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)' }}>
              ...
              <div className="float-right">
                ...
                <div className="text-value">
                <ReactCountUp delay={10} endVal={DadosRODeceased} duration= {2.5} />
                  </div>
        ...
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsRODia></LineChartsRODia>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsROConfRate></LineChartsROConfRate>
            </Card>
          </Col>
        </Row>
        <Row>
          <Col>
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <LineChartsROLetal></LineChartsROLetal>
            </Card>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <HBarChartsDistrictsInfRO></HBarChartsDistrictsInfRO>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="6">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
           <HBarChartsDistrictsDeathRO></HBarChartsDistrictsDeathRO>
            </Card>
          </Col>
        </Row>
 ...
 * 
   <Row >
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartROInf></PieChartROInf>
            </Card>
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Card style={{ backgroundColor: '#2F353A', borderColor: 'rgba(94, 128, 237, 0.2)'}}>
            <PieChartRODeat></PieChartRODeat>
            </Card>
          </Col>
          </Row>
