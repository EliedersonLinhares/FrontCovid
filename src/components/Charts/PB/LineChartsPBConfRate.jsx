        ...
        ? (
            ...
            data={{
               // labels: DadosSPfetched.map(({ date }) => date).reverse(),
                ...
                datasets: [
                  {
                    data: DadosPBFullfetched.map(({  last_available_confirmed_per_100k_inhabitants}) =>  (last_available_confirmed_per_100k_inhabitants)).reverse(),
...
export default LineChartsPBConfRate;
/** 
 const LineChart =(
        DadosPB
        ? (
