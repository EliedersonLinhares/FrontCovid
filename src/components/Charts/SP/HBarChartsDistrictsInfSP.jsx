...
const HBarChartsDistrictsInf = () =>{
   ...
   const [DadosSPFullMunicipiosfetched, setFetechedSPFullMunicipios] = useState([])
    ...
    var ordenação = DadosSPFullMunicipiosfetched.sort(function(a, b){return a.last_available_confirmed - b.last_available_confirmed; }).reverse()
        ...
        height='4700vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosSPFullMunicipiosfetched.map(({ last_available_confirmed}) => last_available_confirmed),
          }],
