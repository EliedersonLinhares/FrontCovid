...
const HBarChartsDistrictsInf = () =>{
   ...
   const [DadosSCFullMunicipiosfetched, setFetechedSCFullMunicipios] = useState([])
    ...
    var ordenação = DadosSCFullMunicipiosfetched.sort(function(a, b){return a.last_available_confirmed - b.last_available_confirmed; }).reverse()
        ...
        height='2000vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosSCFullMunicipiosfetched.map(({ last_available_confirmed}) => last_available_confirmed),
          }],
