...
const HBarChartsDistrictsDeath = () =>{
   ...
   const [DadosGOFullMunicipiosfetched, setFetechedGOFullMunicipios] = useState([])
    ...
    var ordenação = DadosGOFullMunicipiosfetched.sort(function(a, b){return a.last_available_deaths - b.last_available_deaths; }).reverse()
        ...
        height='2000vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosGOFullMunicipiosfetched.map(({ last_available_deaths}) => last_available_deaths),
          }],
