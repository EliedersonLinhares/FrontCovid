...
const HBarChartsDistrictsDeath = () =>{
   ...
   const [DadosAMFullMunicipiosfetched, setFetechedAMFullMunicipios] = useState([])
    ...
    var ordenação = DadosAMFullMunicipiosfetched.sort(function(a, b){return a.last_available_deaths - b.last_available_deaths; }).reverse()
        ...
        height='1000vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosAMFullMunicipiosfetched.map(({ last_available_deaths}) => last_available_deaths),
          }],
