...
const HBarChartsDistrictsDeath = () =>{
   ...
   const [DadosRNFullMunicipiosfetched, setFetechedRNFullMunicipios] = useState([])
    ...
    var ordenação = DadosRNFullMunicipiosfetched.sort(function(a, b){return a.last_available_deaths - b.last_available_deaths; }).reverse()
        ...
        height='1400vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosRNFullMunicipiosfetched.map(({ last_available_deaths}) => last_available_deaths),
          }],
