...
const HBarChartsDistrictsInf = () =>{
   ...
   const [DadosPAFullMunicipiosfetched, setFetechedPAFullMunicipios] = useState([])
    ...
    var ordenação = DadosPAFullMunicipiosfetched.sort(function(a, b){return a.last_available_confirmed - b.last_available_confirmed; }).reverse()
        ...
        height='2000vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosPAFullMunicipiosfetched.map(({ last_available_confirmed}) => last_available_confirmed),
          }],
