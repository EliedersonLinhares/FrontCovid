        ...
        ? (
            ...
            data={{
               // labels: DadosSPfetched.map(({ date }) => date).reverse(),
                ...
                datasets: [
                  {
                    data: DadosMAFullfetched.map(({  last_available_death_rate}) =>  ((last_available_death_rate)*100).toFixed(2)).reverse(),
                    label: 'Letalitade',
                    borderColor: '#f67b55',
...
export default LineChartsMALetal;
/** 
 const LineChart =(
        DadosMA
        ? (
