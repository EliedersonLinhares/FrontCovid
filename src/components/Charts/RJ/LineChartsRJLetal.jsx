        ...
        ? (
            ...
            data={{
               // labels: DadosSPfetched.map(({ date }) => date).reverse(),
                ...
                datasets: [
                  {
                    data: DadosRJFullfetched.map(({  last_available_death_rate}) =>  ((last_available_death_rate)*100).toFixed(2)).reverse(),
                    label: 'Letalitade',
                    borderColor: '#f67b55',
...
export default LineChartsRJLetal;
/** 
 const LineChart =(
        DadosRJ
        ? (
