...
const HBarChartsDistrictsDeath = () =>{
   ...
   const [DadosRJFullMunicipiosfetched, setFetechedRJFullMunicipios] = useState([])
    ...
    var ordenação = DadosRJFullMunicipiosfetched.sort(function(a, b){return a.last_available_deaths - b.last_available_deaths; }).reverse()
        ...
        height='1400vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosRJFullMunicipiosfetched.map(({ last_available_deaths}) => last_available_deaths),
          }],
