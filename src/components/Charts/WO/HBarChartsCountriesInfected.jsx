...
import {CountriesTotalConfirmed} from '../../API/WO';
import {HorizontalBar} from 'react-chartjs-2';
//import ChartDataLabels from 'chartjs-plugin-datalabels';


const HBarChartsCountriesInfected = () =>{
   ...
   const [WorldCountriesTotalfetched, setFetechedWorldCountriesTotal] = useState([])
    useEffect(() => {
      const fetchAPI = async () =>{
         setFetechedWorldCountriesTotal(await CountriesTotalConfirmed());
   ...
   // console.log(WorldCountriesTotalfetched)
    ...
    var ordenação = WorldCountriesTotalfetched ? (WorldCountriesTotalfetched.sort(function(a, b){return a.TotalConfirmed- b.TotalConfirmed; }).reverse()) : null
...
export default HBarChartsCountriesInfected;
/** 
 const LineChart =(
        DadosRJ
        ? (
