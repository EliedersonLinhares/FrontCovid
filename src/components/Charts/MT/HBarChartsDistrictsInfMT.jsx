...
const HBarChartsDistrictsInf = () =>{
   ...
   const [DadosMTFullMunicipiosfetched, setFetechedMTFullMunicipios] = useState([])
    ...
    var ordenação = DadosMTFullMunicipiosfetched.sort(function(a, b){return a.last_available_confirmed - b.last_available_confirmed; }).reverse()
        ...
        height='850vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosMTFullMunicipiosfetched.map(({ last_available_confirmed}) => last_available_confirmed),
          }],
