...
const HBarChartsDistrictsDeath = () =>{
   ...
   const [DadosALFullMunicipiosfetched, setFetechedALFullMunicipios] = useState([])
    ...
    var ordenação = DadosALFullMunicipiosfetched.sort(function(a, b){return a.last_available_deaths - b.last_available_deaths; }).reverse()
        ...
        height='1500vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosALFullMunicipiosfetched.map(({ last_available_deaths}) => last_available_deaths),
          }],
