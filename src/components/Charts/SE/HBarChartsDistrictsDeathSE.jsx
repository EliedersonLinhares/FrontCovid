...
const HBarChartsDistrictsDeath = () =>{
   ...
   const [DadosSEFullMunicipiosfetched, setFetechedSEFullMunicipios] = useState([])
    ...
    var ordenação = DadosSEFullMunicipiosfetched.sort(function(a, b){return a.last_available_deaths - b.last_available_deaths; }).reverse()
        ...
        height='850vh'
         data={{
          ...
          datasets: [
          {
              ...
              data:DadosSEFullMunicipiosfetched.map(({ last_available_deaths}) => last_available_deaths),
          }],
